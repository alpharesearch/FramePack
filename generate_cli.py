...
def generate_video(args, models, device_info, input_image_path, output_basename, current_seed):
    ...
    try:
        ...
        meta.add_text("Title", f"FramePack Image - {output_basename}")
        ...
        meta.add_text("FramePack_prompt", prompt)
        meta.add_text("FramePack_n_prompt", n_prompt)
        meta.add_text("FramePack_seed", str(current_seed))
        meta.add_text("FramePack_total_second_length", str(total_second_length))
        meta.add_text("FramePack_latent_window_size", str(latent_window_size))
        meta.add_text("FramePack_steps", str(steps))
        meta.add_text("FramePack_cfg", str(cfg))
        meta.add_text("FramePack_gs", str(gs))
        meta.add_text("FramePack_rs", str(rs))
        meta.add_text("FramePack_mp4_crf", str(mp4_crf))
        meta.add_text("FramePack_use_teacache", str(use_teacache))
